...
class MainActivity : AppCompatActivity() {
    ...
    private fun initData() {
        ...
        for (i in judulArtikel.indices) {
            val data = Artikel(
// urutan di sini harus sama dengan urutan di data class nya // kalau bingung bisa pake penulisan property dulu // contoh // titleArtikel = judulArtikel[i], // descArtikel = kontenArticle[i] // imageArtikel = imageArticle.getResourceId(i,0), // dengan gaya penulisan di atas gak perlu lagi khawatir sama urutan property imageArticle.getResourceId(i, 0),
    ...
    private fun initView() {
        ...
        val llSetiapSaatDzikir: LinearLayout = findViewById(R.id.ll_dizkir_setiap_saat)
        ...
        mAdapter.setOnItemClickCallback(object : OnItemCallBack {
            override fun onItemCliked(item: Artikel) {
